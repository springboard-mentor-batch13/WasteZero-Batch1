const CITIES = [
  ...
  { name: 'Balasore', state: 'Odisha', lat: 21.4942, lng: 86.9317 },
  { name: 'Baripada', state: 'Odisha', lat: 21.9347, lng: 86.7331 },
  { name: 'Angul', state: 'Odisha', lat: 20.8400, lng: 85.1012 },
  { name: 'Bhadrak', state: 'Odisha', lat: 21.0574, lng: 86.5153 },
...
const findCityByName = (name) => {
  ...
  return CITIES.find((c) => c.name.toLowerCase() === normalized) || null;
};

module.exports = { CITIES, findCityByName };
